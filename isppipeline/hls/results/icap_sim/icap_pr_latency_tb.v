`timescale 1ns/1ps
// PR latency testbench: streams the real rm_lowlight_partial.bit payload
// through the ICAPE3 UNISIM model at 100 MHz and measures trigger -> real
// DESYNC command (word index 171,615 of 171,633) in the streamed content.
// Why DESYNC detection instead of PRDONE: see icap_pr_latency_tb.md.
